        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <button
            ...
            style={{
              ...
              fontSize: '1rem',
              fontWeight: 'bold',
              cursor: walletLoading || connecting || walletConnected ? 'not-allowed' : 'pointer',
              opacity: walletLoading || connecting || walletConnected ? 0.6 : 1,
            }}
          >
            {walletConnected ? 'Wallet Connected' : walletLoading || connecting ? 'Connecting...' : 'Connect Direct Wallet'}
          </button>
        </div>
