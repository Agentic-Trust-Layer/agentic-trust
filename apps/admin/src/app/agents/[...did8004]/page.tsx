...
export default async function AgentDetailsPage({ params }: DetailsPageParams) {
  ...
  const serializedAgent: AgentsPageAgent = {
    ...
    identityOwnerAccount: (agent as any).identityOwnerAccount ?? (agent as any)?.data?.identityOwnerAccount ?? null,
    identityWalletAccount: (agent as any).identityWalletAccount ?? (agent as any)?.data?.identityWalletAccount ?? null,
    identityOperatorAccount: (agent as any).identityOperatorAccount ?? (agent as any)?.data?.identityOperatorAccount ?? null,
    agentOwnerAccount: (agent as any).agentOwnerAccount ?? (agent as any)?.data?.agentOwnerAccount ?? null,
    agentWalletAccount: (agent as any).agentWalletAccount ?? (agent as any)?.data?.agentWalletAccount ?? null,
    agentOperatorAccount: (agent as any).agentOperatorAccount ?? (agent as any)?.data?.agentOperatorAccount ?? null,
    agentOwnerEOAAccount: (agent as any).agentOwnerEOAAccount ?? (agent as any)?.data?.agentOwnerEOAAccount ?? null,
    smartAgentAccount: (agent as any).smartAgentAccount ?? (agent as any)?.data?.smartAgentAccount ?? null,
