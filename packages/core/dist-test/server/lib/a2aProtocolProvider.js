 ...
 */
import { fetchAgentCard } from './agentCard';
/**
...
export class A2AProtocolProvider {
    ...
    async sendMessage(request) {
        ...
        if (A2AProtocolProvider.isPlaceholderUrl(endpointInfo.endpoint)) {
            throw new Error(`Invalid A2A endpoint: The agent's A2A endpoint appears to be a placeholder URL (${endpointInfo.endpoint}). ` +
...
//# sourceMappingURL=a2aProtocolProvider.js.map