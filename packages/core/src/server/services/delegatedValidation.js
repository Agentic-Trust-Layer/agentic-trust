...
export async function processValidationRequestsWithSessionPackage(params) {
    const { sessionPackage, chainId = DEFAULT_CHAIN_ID, agentIdFilter, requestHashFilter, responseScore = 100, responseUri, responseTag = 'agent-validation', validatorValidated, } = params;
    const results = [];
