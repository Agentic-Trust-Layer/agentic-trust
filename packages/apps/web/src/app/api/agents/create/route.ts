...
import { getAgentTrustClient } from '@/lib/server-client'; // Replace with your app's client getter

/**
 * Create agent API endpoint
 * Auto-generated from @agentic-trust/core
 * 
 * To customize, replace getAgentTrustClient with your app-specific client getter function
 */
export async function POST(request: NextRequest) {
  try {
    const body = await request.json();
    const result = await handleCreateAgent(body, getAgentTrustClient);
