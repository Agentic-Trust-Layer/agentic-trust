 ...
 */
export class AgentKmsSigner extends AbstractSigner {
  private context: IRequiredContext
  private controllerKey: IKey
  override readonly provider: Provider | null
  ...
  connect(provider: Provider | null) {
    ...
    return new AgentKmsSigner(this.controllerKey, this.context, provider) as unknown as Signer
  }
}
