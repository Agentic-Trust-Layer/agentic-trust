...
export class ValidationClient {
    ...
    async validationRequest(params) {
        const result = await this.adapter.send(this.contractAddress, ValidationRegistryABI, 'validationRequest', [params.validatorAddress, params.agentId, params.requestUri, params.requestHash]);
        return {
    ...
    async validationResponse(params) {
        ...
        const result = await this.adapter.send(this.contractAddress, ValidationRegistryABI, 'validationResponse', [params.requestHash, params.response, responseUri, responseHash, tag]);
    ...
    async getIdentityRegistry() {
        return await this.adapter.call(this.contractAddress, ValidationRegistryABI, 'getIdentityRegistry', []);
    }
    /**
    ...
    async getValidationStatus(requestHash) {
        try {
            ...
            const result = await this.adapter.call(this.contractAddress, ValidationRegistryABI, 'getValidationStatus', [requestHash]);
            return {
    ...
    async getSummary(agentId, validatorAddresses, tag) {
        ...
        const result = await this.adapter.call(this.contractAddress, ValidationRegistryABI, 'getSummary', [agentId, validators, tagBytes]);
        return {
    ...
    async getAgentValidations(agentId) {
        return await this.adapter.call(this.contractAddress, ValidationRegistryABI, 'getAgentValidations', [agentId]);
    }
    /**
    ...
    async getValidatorRequests(validatorAddress) {
        return await this.adapter.call(this.contractAddress, ValidationRegistryABI, 'getValidatorRequests', [validatorAddress]);
    }
}
