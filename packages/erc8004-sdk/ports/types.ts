...
export interface GasPolicy {
  // EOA: maxFeePerGas, maxPriorityFeePerGas. AA: sponsorship vs self-fund
  mode: 'self' | 'sponsored';
...
export type PreparedCall = {
  chainId: ChainId;
  description?: string;
  steps: TxRequest[]; // Each {to, data, value}
  // Optional typed data to sign for off-chain auth or commit-reveal
  requiresTypedData?: {
